...
The thing about Json is that it's hard to document - without comments you can only see the what, not the why. You could use "description" fields, but that's not very flexible or clean.
